# Pandas-Trace
Pandas-Trace is a middleware between [Pandas](https://pandas.pydata.org/docs/index.html) and [SDQL (OOPSLA'22)](https://doi.org/10.1145/3527333). 
It parses the pandas code and transforms it to SDQL IR, which is then computed by the C++ code generated by SDQL.py.

__This project is a frontend & optimizer for SDQL database, which has been accepted by [SIGMOD 2023](https://2023.sigmod.org/sigmod_demo_list.shtml) *Efficient Query Processing in Python Using Compilation*__
