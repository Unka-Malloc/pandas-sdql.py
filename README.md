...
__This project is a pipeline for SDQL database, which has been accepted by [SIGMOD 2023](https://2023.sigmod.org/sigmod_demo_list.shtml) *Efficient Query Processing in Python Using Compilation*__
