...
__This project is a frontend & optimizer for SDQL database, which has been accepted by [SIGMOD 2023](https://dl.acm.org/doi/10.1145/3555041.3589735) *Efficient Query Processing in Python Using Compilation*__
