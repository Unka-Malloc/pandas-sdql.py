...
__This project has been accepted by [SIGMOD 2023](https://2023.sigmod.org/sigmod_demo_list.shtml) *Efficient Query Processing in Python Using Compilation*__ *Seyed Hesamoddin Shahrokhi (University of Edinburgh); Callum Groeger (University of Edinburgh); Yizhuo Yang (University of Edinburgh); Amir Shaikhha (University of Edinburgh)**
