...
def q18(li, cu, ord):
    ...
    lineitem_aggr = li.sum(lambda x_l1: ({record({"c_name": customer_orders[x_l1[0].l_orderkey].c_name,
                                                  ...
                                                  "o_totalprice": customer_orders[x_l1[0].l_orderkey].o_totalprice}):
                                              x_l1[0].l_quantity}) if (
                customer_orders[x_l1[0].l_orderkey] != None) else (None))
