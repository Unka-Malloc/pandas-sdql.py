...
from pysdql.core.interfaces.context.FreeState import FreeState
...
def input_fmt(data):
    ...
    if is_date(data):
        ...
        return data
    elif isinstance(data, Replaceable):
        return data.sdql_ir
    elif isinstance(data, IgnoreThisFlag):
        return ConstantExpr(True)
    elif isinstance(data, FreeState):
