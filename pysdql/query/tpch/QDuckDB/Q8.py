...
def query(pa, su, li, ord, cu, na, n1, n2, re):
    ...
    lineitem_orders_customer_nation_region_supplier_nation_part_attach_to_df_aggr_1 = lineitem_orders_customer_nation_region_supplier_nation_part_7.sum(lambda x: {record({"sumcase_a": x[0].sumcase_a, "suml_extendedprice1l_discount": x[0].suml_extendedprice1l_discount}): True})
