...
def query(li, su):
    ...
    supplier_part = su.sum(lambda x_supplier: {x_supplier[0].s_suppkey: record({"s_name": x_supplier[0].s_name, "s_address": x_supplier[0].s_address, "s_phone": x_supplier[0].s_phone})})
