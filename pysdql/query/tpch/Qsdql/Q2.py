...
def query(pa, su, ps, na, re):
    ...
    region_nation_supplier_build_pre_ops = region_nation_0.sum(lambda x: {record({"n_nationkey": x[0].n_nationkey, "n_name": x[0].n_name}): True})
    ...
    region_nation_supplier_region_nation_supplier_ps1_part_partsupp_build_pre_ops = region_nation_supplier_0.sum(lambda x: {record({"s_suppkey": x[0].s_suppkey, "s_acctbal": x[0].s_acctbal, "s_name": x[0].s_name, "n_name": x[0].n_name, "s_address": x[0].s_address, "s_phone": x[0].s_phone, "s_comment": x[0].s_comment}): True})
    ...
    region_nation_supplier_ps1_build_pre_ops = region_nation_supplier_0.sum(lambda x: {record({"s_suppkey": x[0].s_suppkey, "s_acctbal": x[0].s_acctbal, "s_name": x[0].s_name, "n_name": x[0].n_name, "s_address": x[0].s_address, "s_phone": x[0].s_phone, "s_comment": x[0].s_comment}): True})
    ...
    part_partsupp_build_pre_ops = part_0.sum(lambda x: {record({"p_partkey": x[0].p_partkey, "p_mfgr": x[0].p_mfgr}): True})
