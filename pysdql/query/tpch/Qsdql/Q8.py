...
def query(pa, su, li, ord, cu, na, re):
    ...
    region_nation = na.sum(lambda x_nation: ({x_nation[0].n_nationkey: record({"n1_nationkey": x_nation[0].n1_nationkey})}) if (region_part[x_nation[0].n_regionkey] != None) else (None))
