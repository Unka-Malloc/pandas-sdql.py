...
if __name__ == '__main__':
    ...
    l1 = pysdql.read_tbl(path=r'T:/UG4-Proj/datasets/lineitem.tbl', names=l1_cols, r_name='l1')
    ...
    l2 = pysdql.read_tbl(path=r'T:/UG4-Proj/datasets/lineitem.tbl', names=l2_cols, r_name='l2')
    ...
    l3 = pysdql.read_tbl(path=r'T:/UG4-Proj/datasets/lineitem.tbl', names=l3_cols, r_name='l3')
